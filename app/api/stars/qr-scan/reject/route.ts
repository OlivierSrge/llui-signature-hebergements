// app/api/stars/qr-scan/reject/route.ts
// POST { requestId, partenaireId } — rejet depuis StarTerminal partenaire

import { NextRequest, NextResponse } from 'next/server'
import { rejectQrScanRequest } from '@/actions/qr-scan'
...
export async function POST(req: NextRequest) {
  ...
  const result = await rejectQrScanRequest(requestId, partenaireId)
