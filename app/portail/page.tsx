...
async function getData() {
  try {
    ...
    // Requête indépendante : si l'index composite n'existe pas encore, on retourne [] sans bloquer
    ...
    try {
      const transactionsSnap = await db.collection('transactions')
        ...
        .limit(20)
        .get()
      reservations = transactionsSnap.docs.map(doc => {
        const td = doc.data()
    ...
    } catch { /* index en cours de création — le bloc s'affichera dès qu'il sera disponible */ }
    return {
      uid,
